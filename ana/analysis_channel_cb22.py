...
for ROB in [15]:
    ...
    path1 = "../TTtele/Result_test7/" + filename
    path3 = "../TTtele/Result_test8/" + filename
    path4 = "../TTtele/data/ped_cCB-22_2023-12-18_18_19_hist.root"
    path5 = "../TTtele/data/ped_cCB-22_2023-12-18_18_20_hist.root"

    # Create a PdfPages object to save figures into a PDF file
    pdf_pages = PdfPages("./Result/TT_ROB" + str(ROB) + "_waveform.pdf")
    ...
    for i in range(64):
        ...
        with uproot.open(path1) as file:
            ...
            if i < 10:
                hist = (
                    "h_charge_ROB" + str(ROB) + "_ch0" + str(i) + "_sigma_" + str(sigma)
                )
            else:
                hist = (
                    "h_charge_ROB" + str(ROB) + "_ch" + str(i) + "_sigma_" + str(sigma)
                )
